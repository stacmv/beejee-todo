<article class="app_content container-fluid">
	...
	<div class="row-fluid">
		<div class="span6 offset2">
			...
			<form class="form-horizontal" action="task/edit" method="post">
                <!-- @TODO: add CSRF token someday -->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="email" name="email" id="email" class="form-control" value="<?=$task->email;?>" required="">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="5" cols="20" id="text" class="form-control input-xxlarge " required="" name="text"><?=$task->text;?></textarea> 
                    </div>
                </div>
